...
EXPLAIN_OPTIONS='debug=true, dialect-specific=false, extra-device-info=false,
    internal-strerror=true, numeric-errno=false, program-name=false,
    symbolic-mode-bits=true'
export EXPLAIN_OPTIONS
