...
#ifndef EXPLAIN_FCHOWN_H
#define EXPLAIN_FCHOWN_H

/**
  * The explain_syscall_fchown function may be used to
  * interpret a fchown "call" from the
  * command line, and then run it through
  * explain_syscall_errno_fchown for an explanation.
  *
  * @note
  * Because the event being explain happened in another
  * process, the results are not as good as if
  * explain_syscall_errno_fchown had been called
  ...
  *    1:1 to the call arguments.
  */
void explain_syscall_fchown(int errnum, int argc, char **argv);

#endif /* EXPLAIN_FCHOWN_H */
