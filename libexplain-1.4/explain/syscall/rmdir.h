...
#ifndef EXPLAIN_RMDIR_H
#define EXPLAIN_RMDIR_H

/**
  * The explain_syscall_rmdir function may be used to interpret a
  * rmdir "call" from the command line, and then run it through
  * explain_syscall_errno_rmdir for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_syscall_rmdir(int errnum, int argc, char **argv);

#endif /* EXPLAIN_RMDIR_H */
