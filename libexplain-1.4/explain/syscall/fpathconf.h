...
#ifndef EXPLAIN_FPATHCONF_H
#define EXPLAIN_FPATHCONF_H

/**
  * The explain_syscall_fpathconf function may be used to
  * interpret a fpathconf "call" from the
  * command line, and then run it through
  * explain_syscall_errno_fpathconf for an explanation.
  *
  * @note
  * Because the event being explain happened in another
  * process, the results are not as good as if
  * explain_syscall_errno_fpathconf had been called
  ...
  *    1:1 to the call arguments.
  */
void explain_syscall_fpathconf(int errnum, int argc, char **argv);

#endif /* EXPLAIN_FPATHCONF_H */
