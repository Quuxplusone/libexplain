...
#ifndef EXPLAIN_CLOSE_H
#define EXPLAIN_CLOSE_H

/**
  * The explain_syscall_close function may be used to interpret a close
  * "call" from the command line, and then run it through
  * explain_syscall_errno_close for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_syscall_close(int errnum, int argc, char **argv);

#endif /* EXPLAIN_CLOSE_H */
