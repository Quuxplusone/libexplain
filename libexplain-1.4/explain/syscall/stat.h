...
#ifndef EXPLAIN_STAT_H
#define EXPLAIN_STAT_H

/**
  * The explain_syscall_stat function may be used to interpret a
  * stat "call" from the command line, and then run it through
  * explain_syscall_errno_stat for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_syscall_stat(int errnum, int argc, char **argv);

#endif /* EXPLAIN_STAT_H */
