...
#ifndef EXPLAIN_DUP2_H
#define EXPLAIN_DUP2_H

/**
  * The explain_syscall_dup2 function may be used to
  * interpret a dup2 "call" from the
  * command line, and then run it through
  * explain_syscall_errno_dup2 for an explanation.
  *
  * @note
  * Because the event being explain happened in another
  * process, the results are not as good as if
  * explain_syscall_errno_dup2 had been called
  ...
  *    1:1 to the call arguments.
  */
void explain_syscall_dup2(int errnum, int argc, char **argv);

#endif /* EXPLAIN_DUP2_H */
