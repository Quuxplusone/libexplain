...
#ifndef EXPLAIN_OPEN_H
#define EXPLAIN_OPEN_H

/**
  * The explain_syscall_open function may be used to interpret a open "call"
  * from the command line, and then run it through explain_syscall_errno_open
  * for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_syscall_open(int errnum, int argc, char **argv);

#endif /* EXPLAIN_OPEN_H */
