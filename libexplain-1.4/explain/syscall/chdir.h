...
#ifndef EXPLAIN_CHDIR_H
#define EXPLAIN_CHDIR_H

/**
  * The explain_syscall_chdir function may be used to interpret a
  * chdir "call" from the command line, and then run it through
  * explain_syscall_errno_chdir for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_syscall_chdir(int errnum, int argc, char **argv);

#endif /* EXPLAIN_CHDIR_H */
