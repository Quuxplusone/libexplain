...
#ifndef EXPLAIN_FTRUNCATE_H
#define EXPLAIN_FTRUNCATE_H

/**
  * The explain_syscall_ftruncate function may be used to
  * interpret a ftruncate "call" from the
  * command line, and then run it through
  * explain_syscall_errno_ftruncate for an explanation.
  *
  * @note
  * Because the event being explain happened in another
  * process, the results are not as good as if
  * explain_syscall_errno_ftruncate had been called
  ...
  *    1:1 to the call arguments.
  */
void explain_syscall_ftruncate(int errnum, int argc, char **argv);

#endif /* EXPLAIN_FTRUNCATE_H */
