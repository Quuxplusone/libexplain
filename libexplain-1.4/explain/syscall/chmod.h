...
/**
  * The explain_syscall_chmod function may be used to interpret a chmod "call"
  * from the command line, and then run it through explain_syscall_errno_chmod
  * for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_syscall_chmod(int errnum, int argc, char **argv);
