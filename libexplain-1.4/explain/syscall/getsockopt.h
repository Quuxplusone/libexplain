...
#ifndef EXPLAIN_GETSOCKOPT_H
#define EXPLAIN_GETSOCKOPT_H

/**
  * The explain_syscall_getsockopt function may be used to
  * interpret a getsockopt "call" from the
  * command line, and then run it through
  * explain_syscall_errno_getsockopt for an explanation.
  *
  * @note
  * Because the event being explain happened in another
  * process, the results are not as good as if
  * explain_syscall_errno_getsockopt had been called
  ...
  *    1:1 to the call arguments.
  */
void explain_syscall_getsockopt(int errnum, int argc, char **argv);

/* vim:ts=8:sw=4:et */
#endif /* EXPLAIN_GETSOCKOPT_H */
