...
#ifndef EXPLAIN_LINK_H
#define EXPLAIN_LINK_H

/**
  * The explain_syscall_link function may be used to interpret a
  * link "call" from the command line, and then run it through
  * explain_syscall_errno_link for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_syscall_link(int errnum, int argc, char **argv);

#endif /* EXPLAIN_LINK_H */
