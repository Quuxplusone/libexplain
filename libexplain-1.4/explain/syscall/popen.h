...
#ifndef EXPLAIN_POPEN_H
#define EXPLAIN_POPEN_H

/**
  * The explain_syscall_popen function may be used to
  * interpret a popen "call" from the
  * command line, and then run it through
  * explain_syscall_errno_popen for an explanation.
  *
  * @note
  * Because the event being explain happened in another
  * process, the results are not as good as if
  * explain_syscall_errno_popen had been called
  ...
  *    1:1 to the call arguments.
  */
void explain_syscall_popen(int errnum, int argc, char **argv);

/* vim:ts=8:sw=4:et */
#endif /* EXPLAIN_POPEN_H */
