...
#ifndef EXPLAIN_WRITE_H
#define EXPLAIN_WRITE_H

/**
  * The explain_syscall_write function may be used to interpret a write
  * "call" from the command line, and then run it through
  * explain_syscall_errno_write for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_syscall_write(int errnum, int argc, char **argv);

#endif /* EXPLAIN_WRITE_H */
