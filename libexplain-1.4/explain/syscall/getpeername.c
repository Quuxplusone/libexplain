...
void
explain_syscall_getpeername(int errnum, int argc, char **argv)
{
    int             fildes;
    ...
    case 2:
        sock_addr_p = (void *)explain_strtol_or_die(argv[1], 0, 0);
        /* fall through... */
    ...
    default:
        fprintf(stderr, "getpeername: requires 3 arguments, not %d\n", argc);
        exit(EXIT_FAILURE);
    }
