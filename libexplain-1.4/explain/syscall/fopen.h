...
#ifndef EXPLAIN_FOPEN_H
#define EXPLAIN_FOPEN_H

/**
  * The explain_syscall_fopen function may be used to interpret an
  * fopen "call" from the command line, and then run it through
  * explain_syscall_errno_fopen for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_syscall_fopen(int errnum, int argc, char **argv);

#endif /* EXPLAIN_FOPEN_H */
