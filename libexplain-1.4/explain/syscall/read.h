...
#ifndef EXPLAIN_READ_H
#define EXPLAIN_READ_H

/**
  * The explain_syscall_read function may be used to interpret a read "call"
  * from the command line, and then run it through explain_syscall_errno_read
  * for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_syscall_read(int errnum, int argc, char **argv);

#endif /* EXPLAIN_READ_H */
