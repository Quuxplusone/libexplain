...
#ifndef EXPLAIN_DUP_H
#define EXPLAIN_DUP_H

/**
  * The explain_syscall_dup function may be used to
  * interpret a dup "call" from the
  * command line, and then run it through
  * explain_syscall_errno_dup for an explanation.
  *
  * @note
  * Because the event being explain happened in another
  * process, the results are not as good as if
  * explain_syscall_errno_dup had been called
  ...
  *    1:1 to the call arguments.
  */
void explain_syscall_dup(int errnum, int argc, char **argv);
