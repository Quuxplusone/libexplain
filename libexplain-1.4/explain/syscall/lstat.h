...
#ifndef EXPLAIN_LSTAT_H
#define EXPLAIN_LSTAT_H

/**
  * The explain_syscall_lstat function may be used to interpret a
  * lstat "call" from the command line, and then run it through
  * explain_syscall_errno_lstat for an explanation.
  *
  * @note
  ...
  *    arguments
  */
void explain_syscall_lstat(int errnum, int argc, char **argv);

#endif /* EXPLAIN_LSTAT_H */
