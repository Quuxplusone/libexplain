...
#ifndef EXPLAIN_LCHOWN_H
#define EXPLAIN_LCHOWN_H

/**
  * The explain_syscall_lchown function may be used to
  * interpret a lchown "call" from the
  * command line, and then run it through
  * explain_syscall_errno_lchown for an explanation.
  *
  * @note
  * Because the event being explain happened in another
  * process, the results are not as good as if
  * explain_syscall_errno_lchown had been called
  ...
  *    1:1 to the call arguments.
  */
void explain_syscall_lchown(int errnum, int argc, char **argv);

#endif /* EXPLAIN_LCHOWN_H */
