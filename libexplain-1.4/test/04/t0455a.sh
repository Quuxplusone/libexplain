...
flags = 0) failed, Operation not permitted (EPERM) because firewall rules
forbid connection
fubar
test $? -eq 0 || no_result

explain -eEPERM accept4 42 0x12340000 0x12345000 0 > test.out
test $? -eq 0 || fail
