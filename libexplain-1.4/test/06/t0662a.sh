...
Permission denied (EACCES) because the process does not have the necessary
shared memory segment access permissions, and the process is not privileged
fubar
test $? -eq 0 || no_result

explain -eEACCES shmctl 666 IPC_STAT > test.out.4
test $? -eq 0 || fail
