...
usage(void)
{
    fprintf(stderr, "Usage: test_utimens <pathname> [ <time1> [ <time2> ]]\n");
    fprintf(stderr, "       test_utimens -V\n");
    exit(EXIT_FAILURE);
}
...
main(int argc, char **argv)
{
    ...
    {
    case 3:
        explain_parse_timespec_or_die(argv[optind + 2], "arg3", &data[1]);
        /* Fall through... */

    case 2:
        explain_parse_timespec_or_die(argv[optind + 1], "arg2", &data[0]);
        /* Fall through... */
